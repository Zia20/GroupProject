          ...
          <Col>
            <div>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <input className="rounded text-success mb-1" type="text" required value={firstName} onChange={ (event) => {setFirstName(event.target.value)} } /><br />

                <label>Complainant's Last Name:</label><br />
                <input className="rounded mb-1" type="text" required value={lastName} onChange={(event) => {setLastName(event.target.value)}} /><br />

                <label>Email:</label><br />
                <input className="rounded mb-2" type="email" required value={email} onChange={(event) => {setEmail(event.target.value)}} /><br />

                <label>Date of report</label> <br />
                <input className="rounded mb-3" type="datetime-local" value={date} onChange={(event) => {setDate(event.target.value)}} /><br />
