    ...
    <div>
      ...
      <div style={carousalStyle} className='mb-3'>
        <Row className='px-5 mx-5'>
          <Col>
            <h1>Attractions</h1>
            <a href="https://www.google.com/maps/search/attractions+calgary/" target="_blank">
          ...
          <Col>
            <h1>Safety</h1>
            <a href="https://www.google.com/maps/search/safety+calgary/" target="_blank">
          ...
          <Col>
            <h1>Tour Guide</h1>
            <a href="https://www.google.com/maps/search/tour+guide+calgary/" target="_blank">
          ...
          <Col>
            <h1>Maps</h1>
            <a href="https://www.google.com/maps/place/Calgary/" target="_blank">
              <Button type='button' className='shadow-none' variant="light">
            <FontAwesomeIcon className='px-4 mx-2' icon={faMapLocationDot} size="2x" style={fontStyle} /></Button> </a>
          </Col>
          <Col>
            <h1>Hospitals</h1>
            <a href="https://www.google.com/maps/search/Hospitals+Calgary" target="_blank">
              <Button type='button' className='shadow-none' variant="light">
