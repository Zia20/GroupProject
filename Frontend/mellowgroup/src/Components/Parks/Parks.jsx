...
const Parks = () => {
  ...
  return (
    <div>
        ...
        <Container fluid='md'>
          <Row>
            <div class="text-center">
              <h1 n>The Most Beautiful Parks</h1>
            ...
            <Carousel>
              <Carousel.Item interval={2000}>
                ...
                <Carousel.Caption>
                  ...
                  <p>Location: <a a href="https://www.google.com/maps/place/Visitor+Centre+-+Fish+Creek+Provincial+Park/@50.9103451,-114.0198039,15z/data=!4m5!3m4!1s0x0:0x2694044fdcb34327!8m2!3d50.910209!4d-114.0197319" class="stretched-link" target="_blank" rel="noreferrer">15979 Bow Bottom Trail SE</a></p>
                </Carousel.Caption>
              </Carousel.Item>
              <Carousel.Item interval={1500}>
                ...
                <Carousel.Caption>
                  ...
                  <p>Location: <a a href="https://www.google.ca/maps/place/Confederation+Park/@51.079769,-114.079318,17z/data=!3m1!4b1!4m5!3m4!1s0x53716f870cce6cc1:0x9977f871fce03e04!8m2!3d51.079769!4d-114.079318?hl=en" class="stretched-link" target="_blank" rel="noreferrer">905 30 Ave NW</a></p>
                </Carousel.Caption>
              </Carousel.Item>
              <Carousel.Item interval={1500}>
                <img width="400" height="750"
                ...
                <Carousel.Caption>
                  ...
                  <p>Location: <a a href="https://www.google.ca/maps/place/Edworthy+Park/@51.0633376,-114.1556968,17z/data=!3m1!4b1!4m5!3m4!1s0x53716e4e8351e247:0x3c54a79f7f6cd44c!8m2!3d51.0633376!4d-114.1556968" class="stretched-link" target="_blank" rel="noreferrer">5050 Spruce Dr. SW</a></p>
                </Carousel.Caption>
              </Carousel.Item>
              <Carousel.Item interval={1500}>
                <img width="400" height="750"
                ...
                <Carousel.Caption>
                  ...
                  <p>Location: <a a href="https://www.google.ca/maps/place/Nose+Hill+Park/@51.1119248,-114.1114232,14z/data=!4m2!3m1!1s0x537165f81dcb7df7:0x7576f90d970ea8af" class="stretched-link" target="_blank" rel="noreferrer">5620 14 St. NW</a></p>
                </Carousel.Caption>
              </Carousel.Item>
              <Carousel.Item interval={1500}>
                <img width="400" height="750"
                ...
                <Carousel.Caption>
                  ...
                  <p>Location: <a a href="https://www.google.ca/maps?q=prince%27s+island+park&hl=en&sll=51.013117,-114.088499&sspn=0.659228,1.722107&hq=prince%27s+island+park&t=m&z=16" class="stretched-link" target="_blank" rel="noreferrer">4 St. and 1 Ave. SW</a></p>
                </Carousel.Caption>
              </Carousel.Item>
              <Carousel.Item interval={1500}>
                <img width="400" height="750"
                ...
                <Carousel.Caption>
                  ...
                  <p>Location: <a a href="https://www.google.ca/maps/place/St+Patrick%27s+Island,+Calgary,+AB/@51.0473074,-114.0420884,17z/data=!3m1!4b1!4m2!3m1!1s0x53717aace7dfa08f:0xfcad0ceaea045ae1" class="stretched-link" target="_blank" rel="noreferrer">1300 Zoo Rd. NE</a></p>
                </Carousel.Caption>
              </Carousel.Item>
              <Carousel.Item interval={1500}>
                <img width="400" height="750"
                ...
                <Carousel.Caption>
                  ...
                  <p>Location: <a a href="https://www.google.ca/maps/place/Sue+Higgins+Park/@50.968224,-114.027801,17z/data=!3m1!4b1!4m2!3m1!1s0x537170cdcfbae539:0xfb863bb88673f0be" class="stretched-link" target="_blank" rel="noreferrer">Southland Dr. & Deerfoot Trail SE</a></p>
                </Carousel.Caption>
              </Carousel.Item>
            </Carousel>
          </Row>
      ...
      <div style={carousalStyle} className='mb-3'>
        <Row className='px-5 mx-5'>
          <Col>
            <h1>Attractions</h1>
            <a href="https://www.google.com/maps/search/attractions+calgary/" target="_blank" rel="noreferrer">
              <Button type='button' className='shadow-none' variant="light"><FontAwesomeIcon className='px-4 mx-2' icon={faGlobe} size="2x" style={fontStyle} /></Button> </a>
          </Col>
          <Col>
            <h1>Safety</h1>
            <a href="https://www.google.com/maps/search/safety+calgary/" target="_blank" rel="noreferrer">
              <Button type='button' className='shadow-none' variant="light"><FontAwesomeIcon className='px-4 mx-2' icon={faCampground} size="2x" style={fontStyle} /></Button></a>
          </Col>
          <Col>
            <h1>Tour Guide</h1>
            <a href="https://www.google.com/maps/search/tour+guide+calgary/" target="_blank" rel="noreferrer">
              <Button type='button' className='shadow-none' variant="light">
            <FontAwesomeIcon className='px-4 mx-2' icon={faEye} size="2x" style={fontStyle} /></Button></a>
          </Col>
          <Col>
            <h1>Maps</h1>
            <a href="https://www.google.com/maps/place/Calgary/" target="_blank" rel="noreferrer">
              <Button type='button' className='shadow-none' variant="light">
            <FontAwesomeIcon className='px-4 mx-2' icon={faMapLocationDot} size="2x" style={fontStyle} /></Button> </a>
          </Col>
          <Col>
            <h1>Hospitals</h1>
            <a href="https://www.google.com/maps/search/Hospitals+Calgary" target="_blank" rel="noreferrer">
              <Button type='button' className='shadow-none' variant="light">
            <FontAwesomeIcon className='px-4 mx-1' icon={faHospital} size="2x" style={fontStyle} /></Button></a>
          </Col>
        </Row>
      </div>
    </div>
