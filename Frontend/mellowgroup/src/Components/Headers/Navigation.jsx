      ...
      <Navbar bg="success" expand="lg" className='py-3 mx-auto'>
        ...
        {user ? (
          ...
          <Navbar.Collapse id="navbarScroll">
            ...
            <Form className="d-flex">
            <Link to="/signup" style={myLink}><Button className='shadow-none mx-2' variant="outline-dark"><FontAwesomeIcon icon={faUserPlus}/>{user.name}</Button></Link>
            </Form>
            <Form className="d-flex">
            <Link to="/signin" style={myLink}><Button className='shadow-none mx-2' variant="outline-dark"><FontAwesomeIcon icon={faRightToBracket}/>Logout</Button></Link>
            </Form>
          </Navbar.Collapse>
        </Container>
        ) : (
