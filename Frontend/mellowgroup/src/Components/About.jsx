      ...
      <Container>
        <Row>
          <Col className="py-5 my-5 text-center">
            <h2>Mandate</h2>
            <p>
              collection of up-to-date information on the state of natural
              parks, which contributes to public understanding in ways, that
          ...
          <Col className="py-5 my-5 text-center">
            ...
            <p>
              {" "}
              is to build a quality and comprehensive technology infrastructure,
              establish and maintain an effective operational environment, and
              deliver quality, prompt, cost effective and reliable technology
              services.
            </p>
          </Col>
          <Col className="py-5 my-5 text-center">
            <h2>Core Values</h2>
            <p>
              respect, engagement, excellence and integrity – provide a common
              framework for our actions as Mellow team members and our
              collaborative work to fulfill our Mandate and our Vision.
            </p>
          </Col>
        </Row>
